...
<head>
    ...
    <style>
        ...
        .pic p{font-size: .5em;text-align: center;position: absolute;top: 60%;width: 90%;margin: 0 5%;}
...
<body>
    <div class="pic">
        <img width="100%" src="{$front_url}/image/download_bj.png">
        <div class="icon">
    ...
    <div class="btns">
        <img src="{$front_url}/image/download_url.png" width="100%">
