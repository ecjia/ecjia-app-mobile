	...
	<div class="span12">
		<form class="form-horizontal" id="form-privilege" name="theForm" action="{$form_action}" method="post" enctype="multipart/form-data" >
			<fieldset>
				...
				<div class="control-group formSep">
					<label class="control-label">{lang key='mobile::mobile.label_img_url'}</label>
					<div class="controls">
				...
				<div class="control-group formSep" >
					<label class="control-label">{lang key='mobile::mobile.label_img_text'}</label>
					<div class="controls">
						<textarea class="span8" name="img_text" cols="40" rows="3">{$rt.img_txt}</textarea>
					</div>
				</div>
				<div class="control-group formSep">
					<label class="control-label">{lang key='mobile::mobile.label_img_sort'}</label>
					<div class="controls">
