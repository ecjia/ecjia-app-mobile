	...
	<div class="span12">
		<form class="form-horizontal" id="form-privilege" name="theForm" action="{$form_action}" method="post" enctype="multipart/form-data" >
			<fieldset>
						...
						{if $rt.img_src eq ''}
							...
							<div class="controls">
								<div class="fileupload fileupload-new" data-provides="fileupload">
									...
									<br />
									<span class="help-block">{t}此快捷菜单的图片标准宽度为：120px   标准高度为：120px{/t}</span>
								</div>
							</div>
						{else}
				...
				<div class="control-group formSep">
					<label class="control-label">{t}菜单链接：{/t}</label>
					<div class="controls">
				...
				<div class="control-group formSep" >
					<label class="control-label">{t}菜单说明：{/t}</label>
					<div class="controls">
...
<!-- 					</div> -->
				...
				<div class="control-group formSep">
					<label class="control-label">{t}菜单排序：{/t}</label>
					<div class="controls">
