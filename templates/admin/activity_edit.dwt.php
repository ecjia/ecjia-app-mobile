	    ...
	    <div class="tabbable">
			...
			<fieldset>
				<div class="control-group formSep">
					<label class="control-label">{lang key='mobile::mobile.activity_name'}</label>
					<div class="controls">
				...
				<div class="control-group formSep" >
					<label class="control-label">{lang key='mobile::mobile.activity_way'}</label>
				     <div class="controls chk_radio">
                           <input type="radio" name="activity_group"  value="1" {if $activity_info.activity_group eq 1 || !$activity_info} checked="true" {/if} />
                           <span>{lang key='mobile::mobile.shake'}</span>
                     </div>
				</div>
				<div class="control-group formSep">
                    <label class="control-label">{lang key='mobile::mobile.join_platform'}</label>
                    <div class="controls chk_radio">
                ...
                <div class="control-group formSep" >
					<label class="control-label">{lang key='mobile::mobile.is_open'}</label>
				   	<div class="controls">
                ...
                <div class="control-group formSep">
					<label class="control-label">{lang key='mobile::mobile.activity_restrict_num'}</label>
					<div class="controls">
						<input class="" name="limit_num" type="text" value="{$activity_info.limit_num|default:0}" maxlength="4"/>
						<span class="help-block">{lang key='mobile::mobile.restrict_num_tips'}</span>
					</div>
				</div>
				<div class="control-group formSep">
					<label class="control-label">{lang key='mobile::mobile.activity_time_restrict'}</label>
					<div class="controls">
						<input class="" name="limit_time" type="text" value="{$activity_info.limit_time|default:0}" placeholder="" maxlength="4"/>
						<span class="help-block">{lang key='mobile::mobile.time_restrict_tips'}</span>
						
					</div>
				</div>
				<div class="control-group formSep">
					<label class="control-label">{lang key='mobile::mobile.start_date'}</label>
					<div class="controls">
						<input class="time" name="start_time" type="text" value="{$activity_info.start_time}" />
					</div>
				</div>
				<div class="control-group formSep">
					<label class="control-label">{lang key='mobile::mobile.end_date'}</label>
					<div class="controls">
						<input class="time" name="end_time" type="text" value="{$activity_info.end_time}"/>
					</div>
				</div>
				<div class="control-group formSep" >
					<label class="control-label">{lang key='mobile::mobile.rule_desc'}</label>
					<div class="controls">
				...
				<div class="control-group">
					<div class="controls">
						...
						{else}
						<input type="submit" class="btn btn-gebo" value="{lang key='mobile::mobile.update'}" />
						{/if}
					</div>
				</div>
			</fieldset>
