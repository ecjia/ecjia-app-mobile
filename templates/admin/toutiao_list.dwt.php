				...
				<table class="table table-striped smpl_tbl table-hide-edit">
					<thead>
						<tr>
							...
							<th class='w200'>{lang key='mobile::mobile.image'}</th>
							<th class='w200'>{lang key='mobile::mobile.headline_title'}</th>
							<th>{lang key='mobile::mobile.tag'}</th>
							<th>{lang key='mobile::mobile.headline_content'}</th>
							<th>{lang key='mobile::mobile.headline_url'}</th>
							<th>{lang key='mobile::mobile.create_time'}</th>
						</tr>
					</thead>
					<tbody>
