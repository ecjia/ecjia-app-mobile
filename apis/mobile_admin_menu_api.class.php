...
class mobile_admin_menu_api extends Component_Event_Api
{
    ...
    public function call(&$options)
    {
        ...
        $submenus = array(
        	...
        	ecjia_admin::make_admin_menu('07_mobile_toutiao', __('今日头条'), RC_Uri::url('mobile/admin_mobile_toutiao/init'), 6)->add_purview('mobile_news_manage'),
        	ecjia_admin::make_admin_menu('divider', '', '', 7)->add_purview('mobile_config_manage', 10),
        	ecjia_admin::make_admin_menu('05_config', __('应用配置'), RC_Uri::url('mobile/admin_config/init'), 8)->add_purview('mobile_config_manage'),
        	ecjia_admin::make_admin_menu('06_mobile_manage', __('客户端管理'), RC_Uri::url('mobile/admin_mobile_manage/init'), 9)->add_purview('mobile_push_config_manage')
        );
