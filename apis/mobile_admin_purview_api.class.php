...
//         	array('action_name' => RC_Lang::get('mobile::mobile.device_delete'), 		'action_code' => 'device_delete', 'relevance' => ''),
        	...
        	array('action_name' => __('移动应用设置', 'mobile'), 'action_code' => 'mobile_config_manage', 'relevance' => ''),
        	...
        	array('action_name' => __('客户端管理', 'mobile'), 	'action_code' => 'mobile_manage', 			'relevance' => ''),
...
//         	array('action_name' => RC_Lang::get('mobile::mobile.mobile_manage_delete'), 'action_code' => 'mobile_manage_delete',	'relevance' => ''),
		    ...
		    array('action_name' => __('店铺街管理', 'mobile'), 'action_code' => 'mobile_street',	'relevance' => ''),
        );
