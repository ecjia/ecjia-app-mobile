...
class admin_config extends ecjia_admin {
	...
	public function init () {
		...
		if (!empty($bonus_readme_url)) {
			$parameter = explode('&', end(explode('?', $bonus_readme_url)));
		...
		$this->assign('mobile_app_icon', $mobile_app_icon);
	  	...
	  	$this->assign('mobile_home_adsense1', ecjia::config('mobile_home_adsense1'));
	  	$this->assign('mobile_home_adsense2', ecjia::config('mobile_home_adsense2'));
	...
	public function update() {
		...
		$mobile_home_adsense1 = $_POST['mobile_home_adsense1'];
		$mobile_home_adsense2 = $_POST['mobile_home_adsense2'];
		...
		$mobile_shopkeeper_urlscheme = $_POST['mobile_shopkeeper_urlscheme'];
		...
		/* 判断是否上传成功 */
		if (!empty($image_info)) {
// 			$mobile_iphone_qr_code = $image_info['savepath'].'/'.$image_info['savename'];
		...
		/* 判断是否上传成功 */
		if (!empty($image_info)) {
// 			$mobile_android_qr_code = $image_info['savepath'].'/'.$image_info['savename'];
		...
		/* 判断是否上传成功 */
		if (!empty($image_info)) {
// 			$mobile_ipad_qr_code = $image_info['savepath'].'/'.$image_info['savename'];
...
// 			$mobile_pad_login_bgimage = $mobile_pad_login_bgimage_info['savepath'].'/'.$mobile_pad_login_bgimage_info['savename'];
...
// 			$mobile_phone_login_bgimage = $mobile_phone_login_bgimage_info['savepath'].'/'.$mobile_phone_login_bgimage_info['savename'];
...
// 			$mobile_app_icon = $mobile_app_icon_info['savepath'].'/'.$mobile_app_icon_info['savename'];
		...
		if (!empty($wap_logo)) {
// 			$wap_logo_icon = $wap_logo['savepath'].'/'.$wap_logo['savename'];
		...
		ecjia_config::instance()->write_config('mobile_home_adsense1', $mobile_home_adsense1);
		ecjia_config::instance()->write_config('mobile_home_adsense2', $mobile_home_adsense2);
