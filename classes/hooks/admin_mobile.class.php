...
class mobile_admin_hooks {
   ...
   public static function append_admin_setting_group($menus) 
   {
       ...
       $menus[] = ecjia_admin::make_admin_menu('basic_info', 'APP基本信息', RC_Uri::url('mobile/admin_config/basic_info_init', array('code' => 'basic_info')), 31)->add_purview('mobile_config_manage');
       $menus[] = ecjia_admin::make_admin_menu('app_download_url', 'APP下载地址', RC_Uri::url('mobile/admin_config/app_download_url', array('code' => 'app_download_url')), 32)->add_purview('mobile_config_manage');
       $menus[] = ecjia_admin::make_admin_menu('app_screenshots', 'APP应用截图', RC_Uri::url('mobile/admin_config/app_screenshots', array('code' => 'app_screenshots')), 33)->add_purview('mobile_config_manage');
